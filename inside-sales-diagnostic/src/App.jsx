...
export default function App() {
  ...
  const downloadImage = () => {
    ...
    html2canvas(target, { 
      ...
      // PNG形式で画像ダウンロード（無圧縮・超高品質）
      const link = document.createElement('a');
      link.href = canvas.toDataURL('image/png');
      link.download = `${result.company}_営業DX診断_${result.overall}点.png`;
    ...
    return (
      <div className={styles.container}>
        ...
        <div className="bg-blue-100 rounded-lg p-6 mb-6">
          <p className="text-center font-semibold text-blue-800 mb-4">📥 診断結果をダウンロード</p>
